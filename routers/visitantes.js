...
appVisitantes.get("/", async (req, res) => {
    let db = await con();
...
appVisitantes.post("/post", async (req, res) => {
    try {
        const db = await con();
...
appVisitantes.put("/update/:id", async (req, res) => {
    try {
...
appVisitantes.delete("/delete/:id", async (req, res) => {
    try {
